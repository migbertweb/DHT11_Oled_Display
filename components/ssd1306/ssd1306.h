/**
 * Archivo: ssd1306.h
 * Descripción: Controlador para pantallas OLED basadas en el controlador SSD1306.
 *              Proporciona una API de alto nivel para controlar pantallas OLED
 *              a través de interfaces I2C o SPI en microcontroladores ESP32.
 * Autor: migbertweb
 * Fecha: 16/11/2025
 * Repositorio: https://github.com/migbertweb/oled_ssd1306
 * Licencia: MIT License
 *
 * Uso: Este archivo de encabezado define las estructuras de datos y funciones
 *      necesarias para controlar pantallas SSD1306. Incluye soporte para:
 *      - Inicialización de hardware (I2C/SPI)
 *      - Control de píxeles y texto
 *      - Operaciones de dibujo básicas
 *      - Control de contraste y visualización
 *
